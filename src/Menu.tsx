...
function Menu() {
    ...
    const onButtonClick = () => {
        setMessage('image fonctionnel en cliquand dessue ');
    ...
    return (
        <div className='flex items-center justify-center h-screen overflow-hidden '>
            ...
            <img src={FicheClient} alt='Fiche Clients'  className="absolute h-52 bottom-5 right-96 cursor-pointer " onClick={onButtonClick}/>
            ...
            {message && (
                <div className="absolute top-5 left-5 bg-green-500 text-white p-3 rounded-md">
                    {message}
            </div>
                )};
        </div>
